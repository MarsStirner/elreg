...
urlpatterns = patterns('',
    ...
    url(r'^lpu/(?P<okato>\d{11})/$', view_lpu.index, {'template_name': 'lpu.html'}),
    ...
    url(r'^specializaciya/(?P<spec>\d{5,13})/$', view_specializaciya.index, {'template_name': 'specializaciya.html'}),
    ...
    url(r'^vremya/(?P<vremya>\d{3}|next|prev)/$', view_vremya.index, {'template_name': 'vremya.html'}),
